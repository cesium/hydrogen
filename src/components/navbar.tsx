...
const Navbar = () => {
  ...
  return (
    <div
      className={`${navbarBackgroundColor} layout-p-x ${isMemberOrCollaborator || isLanding ? "relative after:hidden" : "sticky"} top-0 z-50 select-none after:absolute after:bottom-0 after:left-0 after:h-6 after:w-full after:translate-y-6 after:bg-gradient-to-b after:from-white after:to-transparent md:relative after:md:hidden`}
    >
      <div
