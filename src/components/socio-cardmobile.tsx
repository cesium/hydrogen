...
const ColaboradorCardMobile: React.FC = () => {
  return (
    <div className="relative h-[269px] w-full max-w-[355px] overflow-hidden rounded-xl bg-blue-600 p-4 text-white">
      <button
        aria-label="Fechar"
      ...
      <div className="absolute bottom-4 right-4">
        <button className="hover:bg-gray-100 font-inter rounded-full bg-white px-4 py-2 text-sm text-blue-600 transition duration-300">
          Saber mais
        </button>
      </div>
    </div>
...
export default ColaboradorCardMobile;
