...
export default function BecomeAMember() {
  ...
  return (
    <main>
  <div className="pl-8 lg:pl-24 pt-14 bg-primary text-white flex flex-col lg:flex-row items-center lg:items-start">
    <div className="lg:w-1/2">
      ...
      <p className="text-lg z-10 relative pb-10">
